---
slug: /languages/golang/intro
title: Intro
description: Discover Go, a fast, statically-typed programming language from Google,
  optimized for systems programming with efficient concurrency and package management.
created: '2023-03-05'
