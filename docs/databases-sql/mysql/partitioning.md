---
slug: /databases-sql/mysql/partitioning
title: Partitioning
description: Explore MySQL partitioning techniques including RANGE, LIST, COLUMNS,
  HASH, and KEY to optimize your database performance and management.
created: '2024-06-07'
...
[GitHub - i-sanyam/MySQLPartitionKeeper: Automatically creates new monthly partition and removes oldest partition](https://github.com/i-sanyam/MySQLPartitionKeeper/) ⭐ 4
