---
slug: /computer-science/security/concepts
title: Key Concepts of Security Services
description: Explore essential security services concepts like data confidentiality,
  integrity, and the relationship between authenticity and non-repudiation.
created: '2023-03-05'
...
- This is an implementation of an ACME-based CA. The [ACME protocol](https://github.com/ietf-wg-acme/acme/) ⭐ 942 allows the CA to automatically verify that an applicant for a certificate actually controls an identifier, and allows domain holders to issue and revoke certificates for their domains. Boulder is the software that runs [Let's Encrypt](https://letsencrypt.org/).
