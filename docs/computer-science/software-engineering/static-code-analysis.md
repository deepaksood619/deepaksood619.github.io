---
slug: /computer-science/software-engineering/static-code-analysis
title: Understanding Static Code Analysis
description: Explore static code analysis, its benefits, and how cyclomatic complexity
  measures code quality effectively.
created: '2023-03-05'
...
The tool supports scanning various programming languages including C, C++, C#, Java, JavaScript, HTML, Python, Objective-C, Go, Ruby, PowerShell and [more](https://github.com/microsoft/ApplicationInspector/wiki/2.1-Field:-applies_to-(languages-support) ⭐ 4.4k) and can scan projects with mixed langauge files. It also includes HTML, JSON and text output formats with the default being an HTML report similar to the one shown here.
