---
slug: /computer-science/system-design/message-queues
...
See [Apache Pulsar](technologies/apache/apache-pulsar.md) for a deep dive into its architecture and a detailed Pulsar vs Kafka comparison.
