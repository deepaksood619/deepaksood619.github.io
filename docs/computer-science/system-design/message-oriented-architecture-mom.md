---
slug: /computer-science/system-design/message-oriented-architecture-mom
title: Understanding Message Oriented Architecture (MOM)
description: Explore Message Oriented Architecture (MOM) and its role in distributed
  systems communication using protocols like AMQP and MQTT.
created: '2023-11-26'
