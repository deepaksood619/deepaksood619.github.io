...
- [Transaction, Commit, Rollback](transaction-commit-rollback)
...
- [Administration / Configuration](databases/sql-databases/mysql/administration-configuration.md)
    - [server-sql-modes](databases/sql-databases/mysql/server-sql-modes.md)
- [Partitioning](databases/sql-databases/mysql/partitioning.md)
