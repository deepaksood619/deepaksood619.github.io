---
slug: /technologies/kafka/kafka-listeners
title: Understanding Kafka Listeners
description: Learn how to configure Kafka listeners for proper client connection using
  advertised.listeners in Docker and AWS scenarios.
created: '2023-03-05'
