...
For **Confluent Cloud**, follower fetching is currently documented and GA for **AWS only**:

`client.rack=<AWS-Availability-Zone-ID>`

|Cluster type|Supported networking|
|---|---|
|Enterprise|AWS PNI|
|Freight|AWS PNI|
|Dedicated|AWS VPC Peering|
