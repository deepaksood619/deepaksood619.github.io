---
slug: /technologies/kafka/kafka-rest-proxy
title: Kafka REST Proxy Overview
description: Explore the Kafka REST Proxy for easy data production, consumption, and
  cluster management via a simple RESTful interface.
created: '2023-03-05'
...
[GitHub - confluentinc/kafka-rest: Confluent REST Proxy for Kafka](https://github.com/confluentinc/kafka-rest) ⭐ 160
