...
Compliance and privacy constantly evolve, with new regulations and mandates being developed on a regular basis. [Confluent.io/trust-and-security](https://www.confluent.io/trust-and-security/?session_ref=direct) provides a breakdown of the regulations and mandates as of publishing. You can review the details of each regulation, and request more information, by clicking **Request Documentation** at the bottom of the page.