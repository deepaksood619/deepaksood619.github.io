...
I | Uses the same AWS primitives as EKS and Lambda
...
I | Gateway is the top-level connectivity abstraction in PNI
...
I | Access Point connects Gateway to actual ENIs
...
I | This ownership model is key to PNI's security benefits
...
I | Compare to PrivateLink: $0.05/GB + $0.01/GB traffic charges
...
I | Freight offers the best cost optimization with PNI
...
I | PNI is currently AWS-exclusive; other cloud providers coming
...
I | But one gateway can access multiple clusters in same region
...
I | Freight + PNI achieves 50% savings vs Enterprise + PrivateLink
...
I | Cross-AZ costs represent 80-90% of infrastructure costs after storage optimization
...
I | Security Groups on ENIs = centralized policy + smaller attack surface
...
I | VPC Peering lacks centralized policy enforcement
...
I | PrivateLink routes through AWS managed endpoints = extra hop = extra cost
...
I | Important for managed connectors accessing private data sources
...
I | Manual setup provides more control over security group configuration
...
I | Indeed case study: 60% reduction in network transfer costs
...
I | This can cause IP address overlap challenges in some architectures
...
I | This limits use cases like managed connectors accessing private data sources
...
I | But removes requirement for 1:1 peering connections within AWS
...
I | Easiest to set up but least secure option
...
I | This is an important architectural constraint for hybrid networking
...
I | But one gateway can serve multiple clusters in same region
...
I | Switching between them is fully supported without cluster redeployment
...
I | DNS complexity is one hidden cost of PrivateLink
...
I | This is key difference from PrivateLink which is unidirectional
...
I | Must avoid excluded ranges: 10.100/16, 10.255/16, 172.17/16, 172.20/16
...
I | Exception: Google Cloud custom route import/export for VPN/Interconnect
...
I | This is required for domain name resolution to work properly
...
I | Google VPCs are global but Confluent Cloud access is region-bound
...
I | Must be directly reachable in peered VPC
...
I | This is a major advantage for networks with limited IP space
...
I | Both use wildcard DNS records to route traffic to endpoints
...
I | Single-zone clusters create only one endpoint in one subnet
...
I | DNS complexity is the main setup challenge for PrivateLink
...
I | This is a key benefit over VPC peering for hybrid environments
...
I | Once whitelisted, unlimited VPCs/VNets from that account can connect
...
I | Example: 5 VPCs need 10 peer connections; with TGW only 5 connections
...
I | This is a hard limit - can't peer to multiple Transit Gateways
...
I | This is not yet self-service unlike other networking options
...
I | TGW acts as cloud network router for non-direct connections
...
I | Much more flexible than VPC peering which only accesses peered VPC
...
I | Confluent won't initiate connections unless you configure connectors
...
I | /16 = 65K hosts, /24 = 256 hosts, /32 = 1 host
...
I | Public IPs are globally unique and directly accessible
...
I | Same concept, different naming across cloud providers
...
I | Provides fault isolation within a region
...
I | This is why PrivateLink requires special DNS/routing configuration
...
I | This does NOT work for transitive connectivity between Google Cloud VPCs
...
I | This would allow VNet X to access datacenter through VNet Y's ExpressRoute
...
I | Must expose service over internet or self-manage Kafka Connect
...
I | Only Kafka cluster data plane goes through PrivateLink
...
I | PSC has same limitations: no managed connector access to private sources
...
I | Makes hybrid and multi-cloud architectures much simpler
