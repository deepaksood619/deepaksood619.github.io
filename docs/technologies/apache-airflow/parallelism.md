---
slug: /technologies/apache-airflow/parallelism
title: Understanding Parallelism in Airflow
description: Explore the configuration options for parallelism in Airflow v1.10.2,
  including per-DAG settings for concurrency and active runs.
created: '2024-03-21'
