---
slug: /python/python-intro/generators
title: Understanding Python Generators
description: Explore how generator functions and the yield statement work in Python
  to create efficient iterators and manage state.
created: '2023-03-05'
