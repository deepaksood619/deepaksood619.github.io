---
slug: /devops/terminal-bash/1-linux-general-unix-linux-commands
...
- Others - [GitHub - BurntSushi/ripgrep: ripgrep recursively searches directories for a regex pattern while respecting your gitignore · GitHub](https://github.com/burntsushi/ripgrep) ⭐ 68k
...
printf "\e]1337;SetBadgeFormat=$(echo -n "ProxyConsumer" | base64)\a\e]1337;SetColors=badge=ffffff\a"
