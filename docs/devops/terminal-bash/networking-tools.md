...
3. [bmon](https://github.com/tgraf/bmon) ⭐ 1.4k--bandwidth monitor and rate estimator.
...
9. [dstat](https://github.com/dagwieers/dstat) ⭐ 1.4k--replacement for vmstat, iostat, mpstat, netstat and ifstat.
...
18. [iperf3](https://github.com/esnet/iperf) ⭐ 8.3k-- network bandwidth measurement tool
...
31. [Netperf](https://github.com/HewlettPackard/netperf) ⭐ 951-- Network bandwidth Testing.
...
35. [ngrep](https://github.com/jpr5/ngrep/) ⭐ 1.0k--grep applied to the network layer.
...
48. [speedtest-cli](https://github.com/sivel/speedtest-cli) ⭐ 14k-- test internet bandwidth using speedtest.net
...
52. [tcptrack](https://github.com/bchretien/tcptrack) ⭐ 59-- Displays information about tcp connections on a network interface.
...
57. [websocat](https://github.com/vi/websocat) ⭐ 8.4k-- Connection forwarder from/to web sockets to/from usual sockets, in style of socat.
