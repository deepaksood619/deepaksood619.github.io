...
[GitHub - wader/fq: jq for binary formats - tool, language and decoders for working with binary and text formats](https://github.com/wader/fq) ⭐ 11k
...
Interactive filters, like [fzy](https://github.com/jhawthorn/fzy) ⭐ 3.3k, [percol](https://github.com/mooz/percol) ⭐ 3.3k, [peco](https://github.com/peco/peco) ⭐ 7.9k or [fzf](https://github.com/junegunn/fzf) ⭐ 81k help you with filtering long lines of text. This can either be the aforementioned command history, all the lines of code in a project directory, or a list of filenames generated byfind .. The general idea here is to present you first with all the lines available and then rely on fuzzy finding algorithms to filter out everything that doesn't match.
...
[GitHub - a-j-wood/pv: Pipe Viewer - monitor the progress of data through a pipe](https://github.com/a-j-wood/pv) ⭐ 179
...
[GitHub - YS-L/csvlens: Command line csv viewer](https://github.com/YS-L/csvlens) ⭐ 3.8k
