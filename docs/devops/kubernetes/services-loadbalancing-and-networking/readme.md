...
The [Container Network Interface](https://github.com/containernetworking/cni) ⭐ 6.1k(CNI) is an API specification that is focused around the creation and connection of container workloads.
