---
slug: /devops/terraform/confluent-provider
title: Confluent Terraform Provider Guide
description: Simplify your Apache Kafka deployment with the Confluent Terraform Provider
  to manage Kafka clusters, ACLs, and more efficiently.
created: '2026-01-28'
...
- If you're interested in a more granular setup with TF configuration split between a Kafka Ops team and a Product team, see [kafka-ops-env-admin-product-team](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/kafka-ops-env-admin-product-team) ⭐ 56 and [kafka-ops-kafka-admin-product-team](https://github.com/confluentinc/terraform-provider-confluent/tree/master/examples/configurations/kafka-ops-kafka-admin-product-team) ⭐ 56
