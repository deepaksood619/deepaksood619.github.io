---
slug: /algorithms/searching-sorting/insertion-sort
title: Insertion Sort Explained
description: Learn how insertion sort works, its efficiency, and implications for
  sorting arrays with distinct keys.
created: '2023-03-05'
