...
- Immutable truth - In [philosophy](https://en.wikipedia.org/wiki/Philosophy "Philosophy") and [logic](https://en.wikipedia.org/wiki/Logic "Logic"), an **immutable truth** is an unchanging universal fact or reality that is not influenced by human opinion. According to [positivism](https://en.wikipedia.org/wiki/Positivism "Positivism"), [observation](https://en.wikipedia.org/wiki/Observation "Observation") and [experience](https://en.wikipedia.org/wiki/Experience "Experience") are the only ways for immutable truths to become fully realized or understood.
...
![technology-adoption-lifecycle](../../media/Pasted%20image%2020230920145807.jpg)

- [Jobs To Be Done](http://hbswk.hbs.edu/item/clay-christensens-milkshake-marketing) (JTBD) - "Consumers usually don't go about their shopping by conforming to particular segments. Rather, they take life as it comes. And when faced with a job that needs doing, they essentially 'hire' a product to do that job."
...
Chesterton's fence is the principle that reforms should not be made until the reasoning behind the existing state of affairs is understood. The quotation is from [G. K. Chesterton](https://en.wikipedia.org/wiki/G._K._Chesterton)'s 1929 book The Thing, in the chapter entitled "The Drift from Domesticity":
