...
- **DeepMind** believed in building intelligent architectures that _learned_ (e.g., AlphaGo mastering a complex game from scratch via reinforcement learning).
