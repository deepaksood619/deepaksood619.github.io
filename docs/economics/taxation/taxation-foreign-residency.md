...
- **The "Tax" Hit (TCS):** Any remittance above ₹7 Lakhs in a financial year attracts a 20% **Tax Collected at Source (TCS)**.
    - _Note:_ This is not a "cost" but an advance tax. You can claim this back as a refund when you file your India tax return (ITR), but it locks up your capital for a year.
...
- _Caveat:_ Tax laws change. Keep an eye on the "Direct Tax Code" developments.
...
| ---------------------- | ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **Exchange Rate**      | You convert INR to USD (Loss ~0.5% - 1%) and back.   | Use low-markup banks (e.g., IDFC First, IndusInd) or platforms like Wise (if supported for LRS).                          |
| **US Estate Tax**      | 40% tax on death if holding US assets >$60k.         | **Strictly buy Irish Domiciled ETFs** (UCITS) trading on the London Stock Exchange, not NYSE.                             |
...
| **Returning to India** | If you return to India, you become a resident again. | You must realize (book) your profits **before** you return to India permanently.                                          |
