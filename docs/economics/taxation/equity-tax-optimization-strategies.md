---
slug: /equity-tax-optimization-strategies
title: Equity Tax Optimization Strategies - Real Estate, ESPP & Tax-Loss Harvesting
description: Comprehensive guide to maximizing tax efficiency for tech equity holders using Section 54F real estate exemption, ESPP stock liquidation strategies, and specific-lot tax-loss harvesting
created: 2026-06-24
updated: 2026-06-24
---
...
$$
\text{Taxable LTCG} = \text{Total Capital Gain} \times \left(1 - \frac{\text{Amount Reinvested}}{\text{Net Sale Consideration}}\right)
$$
...
$$
\frac{\text{Number of Old Shares}}{\text{Number of New Shares}} = \frac{\text{Loss per New Share}}{\text{Gain per Old Share}}
$$
...
- [Section 54F Overview](economics/taxation/taxation-domestic.md)
- [ESPP Taxation Details](economics/taxation/taxation-foreign.md)
