...
1. Refining margin (GRM) volatility in global markets
2. Growth investments in retail and digital (expansion costs)
3. New energy capex pre-revenue phase
...
- Industry concern: Pledging `>20%` is a red flag, `>50%` is serious concern
...
- **PEG = 22.7 / 14 = 1.62**
- **Assessment:** PEG `>1.5` suggests modest overvaluation relative to current growth rate
- **However:** PEG doesn't capture future potential from Jio monetization, Retail scaling, and new energy pivot
...
1. Successful execution of new energy transition (green hydrogen, solar)
2. Jio ARPU monetization (tariff hikes from current levels)
3. Retail profitability improvement as scale benefits materialize
4. Re-rating if conglomerate discount narrows (subsidiary listings possible)
...
- **ROCE 10.3%:** Modest for a quality compounder (ideally `>15%` for premium valuation)
- **ROE 8.91%:** **Below quality benchmarks** (high-quality companies typically deliver `>12-15%` ROE)
- **Why Low?**
...
- India's retail sector underpenetrated (organized retail `<12%` of total retail)
- Long runway for growth as income levels rise and consumption patterns shift
...
- If ROE doesn't improve to `>12%` by FY28, valuation re-rating unlikely
- Capital allocation efficiency questionable given massive capex and modest returns
...
- **Debt-to-Equity:** Should remain `<0.6x`; watch for deleveraging or releveraging
- **Interest Coverage:** Should remain strong (`>5x` ideally)
- **Why It Matters:** High capex phase requires monitoring of balance sheet strength
...
- ROE improves to `>11%` sustainably
- New energy production start announced with offtake contracts secured
...
- Significant increase in debt without corresponding EBITDA growth (Debt/Equity `>0.8x`)
...
1. **Jio ARPU** - Should trend toward Rs. 220-250/month
2. **Retail OPM** - Should expand as scale benefits materialize
3. **ROE/ROCE** - Should improve toward 12%+ by FY28
4. **New Energy Milestones** - Green hydrogen production start (2027), solar capacity ramp
5. **Shareholding Pattern** - Promoter pledge should remain 0%, watch FII/DII flows
