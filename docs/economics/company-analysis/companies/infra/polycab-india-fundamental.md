---
slug: /economics/company-analysis/companies/infra/polycab-india-fundamental
title: Polycab India - Fundamental Analysis 2026
description: Polycab India is the domestic wires & cables market leader with 26-27% organized market share, strong ROCE, and a net-cash balance sheet, but trades at a premium 47-52x PE that leaves little room for error.
company: Polycab India Limited
ticker: NSE:POLYCAB / BSE:542652
sector: Capital Goods / Electrical Equipment (Wires & Cables, FMEG)
analysis_type: fundamental
date: 2026-08-03
analyst: Claude (LLM-generated)
data_sources: [WebSearch aggregation - Screener.in, MoneyControl, ICICI Direct, Gurufocus, Tijori Finance, Business Standard, Trendlyne, Tickertape]
tags: [fundamental-analysis, nse, capital-goods, wires-cables, fmeg]
created: 2026-08-03
updated: 2026-08-03
---
...
1. Project Spring execution stays on track (1.5-2x industry growth), FMEG margin mix improves faster than expected as it scales toward FY2030 targets.
2. Continued market-share gains in the organized wires & cables segment as unorganized players lose ground.
3. Copper/commodity costs stay benign, protecting the 11-13% EBITDA margin band the company has targeted for the core cables business.

### Bear Case (Target: Rs. 6,500-7,000 — ~20-27% downside)

1. Multiple compression: any growth disappointment (e.g., a quarter of sub-20% growth) triggers a re-rating from ~50x toward peer-average multiples (~40-45x), which alone implies meaningful downside even with stable earnings.
2. Copper price spike compresses core cables margins faster than pricing can be passed through.
3. FMEG segment (fans, switchgear, lighting) faces intensifying competition from Havells, Crompton, and others, slowing the margin-accretive mix shift.
...
**Investment Recommendation:** Hold existing positions; Accumulate on dips toward Rs. 7,500-8,500; avoid fresh buying at/near 52-week highs
**Suitable For:** Growth-oriented investors with a 2-3+ year horizon who are comfortable holding a quality compounder through periods of rich valuation
**Portfolio Allocation:** 2-4% of portfolio (position-size down given valuation risk, despite high business quality)
