---
slug: /economics/company-analysis/companies/financials/bajaj-finserv-fundamental
title: Bajaj Finserv - Fundamental Analysis 2026
description: Bajaj Finserv is a diversified financial-services holding company (lending via Bajaj Finance, insurance via Bajaj Allianz Life/General) now trading at a discount to its sum-of-parts value after the FY26 Allianz insurance stake buyout, but the holding-company structure and EPS dilution keep the standalone stock's growth optics muted.
company: Bajaj Finserv Limited
ticker: NSE:BAJAJFINSV / BSE:532978
sector: Diversified Financial Services (NBFC Holding Company - Lending + Insurance)
analysis_type: fundamental
date: 2026-08-03
analyst: Claude (LLM-generated)
data_sources: [WebSearch aggregation - Screener.in, ICICI Direct, Business Standard, Upstox, MarketsMojo, Trendlyne, Whalesbook, Allianz press release, Sahi.com]
tags: [fundamental-analysis, nse, nbfc, insurance, financials, holding-company]
created: 2026-08-03
updated: 2026-08-03
---
...
**Investment Recommendation:** Buy (moderate conviction); reasonable entry given the stock is not at its 52-week high and trades within SoTP fair-value range
**Suitable For:** Investors seeking diversified exposure to Indian consumer lending + insurance growth, comfortable with holding-company structure and NBFC credit-cycle risk, with a 2-3+ year horizon
**Portfolio Allocation:** 3-5% of portfolio

## Related Analyses

- [Bajaj Finance - Fundamental Analysis](economics/company-analysis/companies/financials/bajaj-finance-fundamental.md) — the core lending subsidiary, ~54.68% owned by Bajaj Finserv
