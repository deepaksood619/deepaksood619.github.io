---
slug: /rupee-depreciation-reflexivity-market-psychology
title: Rupee Depreciation, Reflexivity & Market Psychology
description: Ananth Narayan (ex-SEBI, former currency trader) on why currency levels are secondary to fundamentals, George Soros's reflexivity, the FPI tax problem, and India's over-financialization.
created: 2026-09-05
updated: 2026-09-05
---

Notes from a Zerodha Varsity bootcamp conversation (Mumbai, 11 July 2026) between Ananth Narayan (former currency trader, ex-SEBI whole-time member) and Nithin Sasikumar / Pranav Agarwal, on what actually drives the rupee and why the psychology around "100" may matter more than the fundamentals. See [USD/INR Exchange Rate Outlook Analysis](economics/sector-analysis/usd-inr-exchange-rate-outlook-analysis.md) for the numeric/technical forecast side of this story.
...
- **Forex reserves adequacy is not a fixed number** - IMF rule of thumb is ~10 months of imports, the Bimal Jalan report suggested ~11 months, but the real test is whether reserves give the market enough confidence that there can't be a "run" on the rupee. India's reserves were ~$680B (net ~$580B after ~$100B in forward sales) versus a prior high of ~$730B.
...
- [Why Rupee Keeps Falling? | Depreciation, Foreign Flows & Market Reflexivity Explained - Zerodha Varsity (YouTube)](https://youtu.be/qyudC07oPOI)
- [USD/INR Exchange Rate Outlook Analysis](economics/sector-analysis/usd-inr-exchange-rate-outlook-analysis.md)
- [Purchasing Power Parity & Price Arbitrage](economics/fundamentals/purchasing-power-parity-price-arbitrage.md)
