...
- [sap](cloud/others/sap.md)
- [GitHub - frappe/erpnext: Free and Open Source Enterprise Resource Planning (ERP)](https://github.com/frappe/erpnext) ⭐ 39k
    - [ERPNext: Free and Open Source Cloud ERP Software](https://erpnext.com/)
- **[GitHub - twentyhq/twenty: Building a modern alternative to Salesforce, powered by the community.](https://github.com/twentyhq/twenty) ⭐ 56k**
