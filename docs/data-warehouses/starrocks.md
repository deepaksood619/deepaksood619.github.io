...
title: StarRocks
description: Discover StarRocks, the fast open query engine delivering sub-second analytics with standard SQL support for efficient data analysis on your lakehouse.
created: 2025-04-20
