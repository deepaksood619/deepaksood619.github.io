...
This wiki is large. 280,000+ lines of markdown (calculated with [loc](https://github.com/cgag/loc) ⭐ 2.5k)
...
--------------------------------------------------------------------------------
 Markdown              2753       392293       113453            0       278840
 JSON                     3        22826            0            0        22826
 JavaScript               5          620           82          142          396
 YAML                     1           50            5           22           23
 CSS                      1           30            2            7           21
 Bourne Shell             3           17            0            3           14
 Plain Text               2            3            0            0            3
--------------------------------------------------------------------------------
 Total                 2768       415839       113542          174       302123
--------------------------------------------------------------------------------
```
...
I update the notes daily in my [github repo](https://github.com/deepaksood619/deepaksood619.github.io/) ⭐ 37 and build it few times in a month using Github Actions and Docusaurus.
