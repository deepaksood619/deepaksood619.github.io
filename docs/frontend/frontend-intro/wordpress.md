...
description: Explore WordPress, a powerful CMS that powers 34% of websites. Learn about its plugins, themes, and key users.
created: 2023-03-05
updated: 2026-06-11
---
...
- [GitHub - woocommerce/wc-mcp-ability: WooCommerce MCP and Ability Integration Demo Plugin · GitHub](https://github.com/woocommerce/wc-mcp-ability) ⭐ 6
- [GitHub - Automattic/mcp-wordpress-remote · GitHub](https://github.com/Automattic/mcp-wordpress-remote) ⭐ 180
...
- [GitHub - WordPress/mcp-adapter: An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically. · GitHub](https://github.com/wordpress/mcp-adapter) ⭐ 1.7k
- [GitHub - techspawn/woocommerce-mcp-server: A WooCommerce (MCP) Model Context Protocol server · GitHub](https://github.com/techspawn/woocommerce-mcp-server) ⭐ 102
