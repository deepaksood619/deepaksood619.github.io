...
title: Redis Queues
description: Discover how Redis Queues use streams for message persistence, consumer
  groups, and efficient data handling in message brokers and chat systems.
created: '2023-03-05'
