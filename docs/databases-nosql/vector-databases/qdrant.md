...
title: Qdrant
description: Qdrant is an open-source vector database designed for AI applications,
  enabling high-performance semantic search with advanced filtering and metadata support.
created: '2025-06-23'
