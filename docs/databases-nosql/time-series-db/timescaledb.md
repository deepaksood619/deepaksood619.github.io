---
slug: /databases-nosql/time-series-db/timescaledb
title: TimeScaleDB
description: Discover TimeScaleDB, an open-source database enhancing SQL scalability
  for time-series data with automatic partitioning and full PostgreSQL support.
created: '2023-03-05'
