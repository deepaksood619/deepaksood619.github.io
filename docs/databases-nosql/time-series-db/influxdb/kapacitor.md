...
title: Kapacitor
description: Kapacitor is an open-source data processing framework for alerts, ETL jobs, and anomaly detection within the TICK stack, supporting both streaming and batch data.
created: 2023-03-05
updated: 2025-06-10
---
