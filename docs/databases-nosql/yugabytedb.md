...
title: YugabyteDB
description: Discover YugabyteDB, a cloud-native distributed SQL database offering
  PostgreSQL features, ideal for scalable, fault-tolerant OLTP applications with data
  correctness.
created: '2023-03-05'
