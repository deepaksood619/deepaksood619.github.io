---
slug: /databases-nosql/etcd
title: etcd
description: Discover etcd, the distributed key-value store used by Kubernetes for reliable data storage, leader elections, and seamless configuration management.
created: 2024-01-23
