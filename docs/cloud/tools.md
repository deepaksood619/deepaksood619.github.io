...
slug: /cloud/tools
title: Tools
description: Explore essential infrastructure and VCS tools like Terraform, Kubernetes, Docker, GitHub, and more for efficient development and project management.
created: 2024-01-30
...
8. Dependabot (github / gitlab)
    ...
    4. [GitHub - renovatebot/tutorial: Renovate Bot Tutorial source](https://github.com/renovatebot/tutorial) ⭐ 171
    5. [GitHub - renovatebot/renovate: Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io](https://github.com/renovatebot/renovate) ⭐ 22k
...
[GitHub - one2nc/cloudlens: k9s like CLI for AWS and GCP](https://github.com/one2nc/cloudlens) ⭐ 590
