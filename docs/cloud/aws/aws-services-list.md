...
8. **AWS Transfer Family** - Fully managed SFTP, FTPS, and FTP service
	...
	2. [GitHub - iterate-ch/cyberduck: Cyberduck is a libre FTP, SFTP, WebDAV, Amazon S3, Backblaze B2, Microsoft Azure & OneDrive and OpenStack Swift file transfer client for Mac and Windows.](https://github.com/iterate-ch/cyberduck) ⭐ 4.4k
