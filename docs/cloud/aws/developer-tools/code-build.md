...
title: Code Build
description: AWS CodeBuild is a fully managed CI service that compiles code, runs
  tests, and produces deploy-ready packages efficiently without managing build servers.
created: '2023-03-05'
