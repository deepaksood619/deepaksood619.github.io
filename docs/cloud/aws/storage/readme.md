...
1. [Amazon S3](cloud/aws/storage/amazon-s3.md) (Blob storage)
	...
	3. [amazon-s3-pricing](cloud/aws/storage/amazon-s3-pricing.md)
	4. [amazon-s3-tables](cloud/aws/storage/amazon-s3-tables.md)
2. [Amazon EBS](cloud/aws/storage/amazon-ebs.md)
	1. [Amazon EBS IOPS](cloud/aws/storage/amazon-ebs-iops.md)
3. [Amazon EFS](cloud/aws/storage/amazon-efs.md)
4. Amazon EC2 Instance Storage
5. [Amazon Glacier](cloud/aws/storage/amazon-glacier.md)
...
12. [Amazon FSx](cloud/aws/storage/amazon-fsx.md) - [Amazon FSx](https://aws.amazon.com/fsx/)
    1. Amazon FSx for NetApp ONTAP
    2. Amazon FSx for OpenZFS
    3. Amazon FSx for Windows File Server
    4. Amazon FSx for Lustre
13. [AWS Backup](cloud/aws/storage/aws-backup.md)
