...
title: Amazon Athena
description: Amazon Athena is a serverless interactive query service for analyzing data in Amazon S3 using standard SQL, delivering rapid results without complex ETL.
created: 2023-03-05
updated: 2026-04-28
---
**Based on Presto**
...
### [GitHub - quux00/hive-json-schema: Tool to generate a Hive schema from a JSON example doc](https://github.com/quux00/hive-json-schema) ⭐ 228
