---
slug: /cloud/aws/analytics/aws-glue/concepts
title: AWS Glue Concepts
description: Discover the key components of AWS Glue, a managed ETL service that simplifies
  data movement with Data Catalogs, Crawlers, ETL Jobs, and Triggers.
created: '2025-12-04'
