---
slug: /cloud/aws/analytics/amazon-opensearch
title: Amazon Opensearch
description: Discover Amazon OpenSearch, a powerful search and analytics service,
  and explore its features, comparisons with Elasticsearch, and getting started guide.
created: '2025-04-03'
...
- [GitHub - opensearch-project/data-prepper: OpenSearch Data Prepper is a component of the OpenSearch project that accepts, filters, transforms, enriches, and routes data at scale.](https://github.com/opensearch-project/data-prepper) ⭐ 367
- [Overview of Amazon OpenSearch Ingestion - Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ingestion.html)
