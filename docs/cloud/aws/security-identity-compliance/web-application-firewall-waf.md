---
slug: /cloud/aws/security-identity-compliance/web-application-firewall-waf
title: Web Application Firewall (WAF)
description: Enhance your security with AWS Web Application Firewall (WAF), protecting
  CloudFront, ALB, API Gateway, and AppSync from threats and vulnerabilities.
created: '2025-11-09'
