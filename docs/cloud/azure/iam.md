---
slug: /cloud/azure/iam
title: IAM
description: Discover how Identity and Access Management (IAM) enhances security with
  Role-Based Access Control in Azure, ensuring proper user authentication and authorization.
created: '2024-03-21'
