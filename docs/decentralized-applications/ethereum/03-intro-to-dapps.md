...
description: Discover decentralized applications (dapps) that run on peer-to-peer
  networks, utilizing smart contracts and offering transparent, secure functionality
  for users.
created: '2023-03-05'
