---
slug: /decentralized-applications/ethereum/03-intro-to-dapps
title: Intro to Dapps
description: Discover decentralized applications (dapps) that run on peer-to-peer networks, utilizing smart contracts and offering transparent, secure functionality for users.
created: 2023-03-05
updated: 2026-03-27
---
...
- [GitHub](https://github.com/austintgriffith/scaffold-eth) ⭐ 9.0k
- [Example dapp](https://punkwallet.io/)

**Create Eth App _\- Create Ethereum-powered apps with one command._**

- [GitHub](https://github.com/paulrberg/create-eth-app) ⭐ 2.7k
