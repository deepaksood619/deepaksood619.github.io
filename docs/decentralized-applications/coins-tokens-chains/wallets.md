...
- Trustwallet (Multi Coin Wallet) - [GitHub - trustwallet/wallet-core: Cross-platform, cross-blockchain wallet library.](https://github.com/trustwallet/wallet-core) ⭐ 3.5k
