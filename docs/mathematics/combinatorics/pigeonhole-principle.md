---
slug: /mathematics/combinatorics/pigeonhole-principle
title: Pigeonhole Principle
description: Discover the Pigeonhole Principle in mathematics, which states that if
  more items than containers exist, at least one container must hold multiple items.
created: '2023-03-05'
