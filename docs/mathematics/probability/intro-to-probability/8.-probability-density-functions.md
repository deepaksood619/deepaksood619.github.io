...
description: Learn about probability density functions (PDFs), their role in statistics,
  and how to convert events into standard normal variables for analysis.
created: '2023-03-05'
