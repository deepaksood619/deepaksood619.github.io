...
I | Introduced in "Attention is All You Need" (2017)
```
...
I | Key insight: attention is computed via matrix multiplication (parallelizable) vs. recurrence (sequential)
```
...
I | Why efficient transformers exist (Linformer, Performer, etc.)
```
