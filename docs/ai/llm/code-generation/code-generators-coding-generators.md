...
- Modernization - [GitHub - codemod-com/codemod: The command line tool for building, sharing, and running codemods. From quick cleanups to complex migrations. AI-friendly, and language-agnostic.](https://github.com/codemod-com/codemod) ⭐ 1.1k
...
- [Zed - Code at the speed of thought](https://zed.dev/) - [GitHub - zed-industries/zed: Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.](https://github.com/zed-industries/zed) ⭐ 90k
- [GitHub - cline/cline: Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way. · GitHub](https://github.com/cline/cline) ⭐ 68k
- [GitHub - Aider-AI/aider: aider is AI pair programming in your terminal · GitHub](https://github.com/Aider-AI/aider) ⭐ 49k
- [GitHub - HKUDS/OpenHarness: "OpenHarness: Open Agent Harness with a Built-in Personal Agent--Ohmo!" · GitHub](https://github.com/HKUDS/OpenHarness) ⭐ 16k

### Google Antigravity vs Gemini Code Assist

Google Antigravity is an agent-first IDE designed for autonomous, multi-step coding tasks, acting as an "agent manager". In contrast, Gemini Code Assist is an enterprise-focused AI assistant that integrates into existing IDEs (like VS Code) for code augmentation, using large-context (1M tokens) across repositories. **Antigravity is superior for AI-driven development; Gemini is better for augmenting traditional IDE workflows**.
...
- [AI Code Generation | Google Cloud](https://cloud.google.com/use-cases/ai-code-generation?hl=en)
	...
	- [GitHub - google-gemini/gemini-cli: An open-source AI agent that brings the power of Gemini directly into your terminal.](https://github.com/google-gemini/gemini-cli) ⭐ 107k
...
- [GitHub - openai/codex: Lightweight coding agent that runs in your terminal](https://github.com/openai/codex) ⭐ 123k
	- [GitHub - Yeachan-Heo/oh-my-codex: OmX - Oh My codeX: Your codex is not alone. Add hooks, agent teams, HUDs, and so much more. · GitHub](https://github.com/Yeachan-Heo/oh-my-codex) ⭐ 33k
	- **[GitHub - ultraworkers/claw-code: The fastest repo in history to surpass 100K stars ⭐. Better Harness Tools that make real things done. Built in Rust using oh-my-codex. · GitHub](https://github.com/ultraworkers/claw-code) ⭐ 195k**
- [GitHub - google-gemini/gemini-cli: An open-source AI agent that brings the power of Gemini directly into your terminal.](https://github.com/google-gemini/gemini-cli) ⭐ 107k
...
- [Kiro: The AI IDE for prototype to production](https://kiro.dev/)
	...
	- [GitHub - kirodotdev/Kiro: Kiro is an agentic IDE that works alongside you from prototype to production.](https://github.com/kirodotdev/Kiro) ⭐ 4.3k
...
- Modernization - [GitHub - codemod-com/codemod: The command line tool for building, sharing, and running codemods. From quick cleanups to complex migrations. AI-friendly, and language-agnostic.](https://github.com/codemod-com/codemod) ⭐ 1.1k
	- [GitHub - codemod-com/codemod: The command line tool for building, sharing, and running codemods. From quick cleanups to complex migrations. AI-friendly, and language-agnostic.](https://github.com/codemod-com/codemod) ⭐ 1.1k
- [Vibecode - AI Mobile App Builder](https://www.vibecodeapp.com/)
- [GitHub - HKUDS/DeepCode: "DeepCode: Open Agentic Coding (Paper2Code & Text2Web & Text2Backend)"](https://github.com/HKUDS/DeepCode) ⭐ 17k
...
- [GitHub - rowboatlabs/rowboat: Open-source AI coworker, with memory · GitHub](https://github.com/rowboatlabs/rowboat) ⭐ 18k
...
- [ai-engineering-hub/sonnet4-vs-qwen3-coder at main · patchy631/ai-engineering-hub · GitHub](https://github.com/patchy631/ai-engineering-hub/tree/main/sonnet4-vs-qwen3-coder) ⭐ 37k
