...
description: Discover top Frontend/UI frameworks and libraries like CopilotKit and
  Assistant UI to enhance AI application development with customizable, high-quality
  components.
created: '2026-06-18'
...
- [GitHub - open-webui/mcpo: A simple, secure MCP-to-OpenAPI proxy server](https://github.com/open-webui/mcpo) ⭐ 4.2k
...
- [GitHub - oobabooga/text-generation-webui: A Gradio web UI for Large Language Models. Supports transformers, GPTQ, AWQ, EXL2, llama.cpp (GGUF), Llama models.](https://github.com/oobabooga/text-generation-webui) ⭐ 47k
- [GitHub - oobabooga/text-generation-webui-extensions](https://github.com/oobabooga/text-generation-webui-extensions) ⭐ 678
