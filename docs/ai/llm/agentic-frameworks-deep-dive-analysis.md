...
| **Links**                 | [GitHub - langchain-ai/langgraph: Build resilient language agents as graphs. · GitHub](https://github.com/langchain-ai/langgraph) ⭐ 30k [GitHub - langchain-ai/langchain: The agent engineering platform · GitHub](https://github.com/langchain-ai/langchain) ⭐ 134k | [GitHub - crewAIInc/crewAI: Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly, tackling complex tasks. · GitHub](https://github.com/crewaiinc/crewai) ⭐ 47k | [GitHub - pydantic/pydantic-ai: AI Agent Framework, the Pydantic way · GitHub](https://github.com/pydantic/pydantic-ai) ⭐ 16k | [GitHub - microsoft/autogen: A programming framework for agentic AI · GitHub](https://github.com/microsoft/autogen) ⭐ 57k[GitHub - ag2ai/ag2: AG2 (formerly AutoGen): The Open-Source AgentOS.Join us at: https://discord.gg/sNGSwQME3x · GitHub](https://github.com/ag2ai/ag2) ⭐ 4.3k | [GitHub - microsoft/semantic-kernel: Integrate cutting-edge LLM technology quickly and easily into your apps · GitHub](https://github.com/microsoft/semantic-kernel) ⭐ 28k |
