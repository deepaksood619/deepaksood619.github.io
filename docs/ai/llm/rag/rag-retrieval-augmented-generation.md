---
slug: /ai/llm/rag/rag-retrieval-augmented-generation
...
- [generative-ai/gemini/use-cases/retrieval-augmented-generation/multimodal\_rag\_langchain.ipynb at main · GoogleCloudPlatform/generative-ai · GitHub](https://github.com/GoogleCloudPlatform/generative-ai/blob/main/gemini/use-cases/retrieval-augmented-generation/multimodal_rag_langchain.ipynb) ⭐ 18k
- [GitHub - Farzad-R/Advanced-QA-and-RAG-Series: This repository contains advanced LLM-based chatbots for Q&A using LLM agents, and Retrieval Augmented Generation (RAG) and with different databases. (VectorDB, GraphDB, SQLite, CSV, XLSX, etc.)](https://github.com/Farzad-R/Advanced-QA-and-RAG-Series) ⭐ 441
- [example-app-langchain-rag/rag\_chain.py at main · streamlit/example-app-langchain-rag · GitHub](https://github.com/streamlit/example-app-langchain-rag/blob/main/rag_chain.py) ⭐ 161
- [GitHub - langchain-ai/rag-from-scratch](https://github.com/langchain-ai/rag-from-scratch) ⭐ 9.3k
- [generative-ai/gemini/qa-ops/building\_DIY\_multimodal\_qa\_system\_with\_mRAG.ipynb at main · GoogleCloudPlatform/generative-ai · GitHub](https://github.com/GoogleCloudPlatform/generative-ai/blob/main/gemini/qa-ops/building_DIY_multimodal_qa_system_with_mRAG.ipynb) ⭐ 18k
...
- Query Expansion (with multiple queries)
    - [GitHub - pdichone/advanced-rag-techniques](https://github.com/pdichone/advanced-rag-techniques) ⭐ 148
    - Downsides
		- Lots of results
...
- [zcookbook/guides/rerank\_llamaparsed\_pdfs/rerank\_llamaparsed\_pdfs.ipynb at main · zeroentropy-ai/zcookbook · GitHub](https://github.com/zeroentropy-ai/zcookbook/blob/main/guides/rerank_llamaparsed_pdfs/rerank_llamaparsed_pdfs.ipynb) ⭐ 21
...
- [FalkorDB Graph Database with GraphRAG for AI/ML and GenAI](https://www.falkordb.com/)
	- [GitHub - FalkorDB/FalkorDB: A super fast Graph Database uses GraphBLAS under the hood for its sparse adjacency matrix graph representation. Our goal is to provide the best Knowledge Graph for LLM (GraphRAG).](https://github.com/FalkorDB/FalkorDB) ⭐ 6.0k
...
- [GitHub - deepsense-ai/ragbits: Building blocks for rapid development of GenAI applications](https://github.com/deepsense-ai/ragbits) ⭐ 1.7k
- [GitHub - vitali87/code-graph-rag: Search Monorepos and get relevant answers](https://github.com/vitali87/code-graph-rag) ⭐ 5.1k
- [GitHub - microsoft/markitdown: Python tool for converting files and office documents to Markdown.](https://github.com/microsoft/markitdown) ⭐ 182k
- **[GitHub - HKUDS/RAG-Anything: "RAG-Anything: All-in-One RAG System"](https://github.com/HKUDS/RAG-Anything) ⭐ 23k**
- [GitHub - yichuan-w/LEANN: RAG on Everything with LEANN. Enjoy 97% storage savings while running a fast, accurate, and 100% private RAG application on your personal device.](https://github.com/yichuan-w/LEANN) ⭐ 13k
...
- [GitHub - RUC-NLPIR/FlashRAG: ⚡FlashRAG: A Python Toolkit for Efficient RAG Research (WWW2025 Resource) · GitHub](https://github.com/RUC-NLPIR/FlashRAG) ⭐ 3.6k
...
- **Transformer Lab** - Transformer Lab is an app to experiment with LLMs: - Train, fine-tune, or chat.
	...
	- [GitHub - transformerlab/transformerlab-app: Open Source Application for Advanced LLM + Diffusion Engineering: interact, train, fine-tune, and evaluate large language models on your own computer.](https://github.com/transformerlab/transformerlab-app) ⭐ 5.2k
- **Llama Factory** - LLaMA-Factory lets you train and fine-tune open-source LLMs and VLMs without writing any code. Supports 100+ models, multimodal fine-tuning, PPO, DPO, experiment tracking, and much more! 100% open-source with 50k stars!
	- [GitHub - hiyouga/LLaMA-Factory: Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024)](https://github.com/hiyouga/LLaMA-Factory) ⭐ 75k
- **Langflow** - Langflow is a drag-and-drop visual tool to build AI agents. It lets you build and deploy AI-powered agents and workflows. Supports all major LLMs, vector DBs, etc. 100% open-source with 82k+ stars!
	- [GitHub - langflow-ai/langflow: Langflow is a powerful tool for building and deploying AI-powered agents and workflows.](https://github.com/langflow-ai/langflow) ⭐ 154k
- **AutoAgent** - AutoAgent is a zero-code framework that lets you build and deploy Agents using natural language. It comes with: - Universal LLM support
	...
	- [GitHub - HKUDS/AutoAgent: "AutoAgent: Fully-Automated and Zero-Code LLM Agent Framework"](https://github.com/HKUDS/AutoAgent) ⭐ 9.8k
...
- [GitHub - beaucarnes/vector-search-tutorial](https://github.com/beaucarnes/vector-search-tutorial) ⭐ 87
- [DSPy: Not Your Average Prompt Engineering](https://jina.ai/news/dspy-not-your-average-prompt-engineering/)
- [langchain/cookbook/RAPTOR.ipynb at master · langchain-ai/langchain · GitHub](https://github.com/langchain-ai/langchain/blob/master/cookbook/RAPTOR.ipynb) ⭐ 146k
