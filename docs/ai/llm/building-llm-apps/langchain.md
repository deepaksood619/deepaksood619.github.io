...
title: Langchain
description: Discover LangChain, a powerful framework for building LLM applications, enhancing productivity and integrating AI seamlessly into your projects.
created: 2026-06-18
updated: 2026-06-18
---
...
- [GitHub - neo4j-labs/llm-graph-builder: Neo4j graph construction from unstructured data using LLMs](https://github.com/neo4j-labs/llm-graph-builder) ⭐ 5.2k
...
- [langgraph-to-data-warehouse](ai/llm/building-llm-apps/langgraph-to-data-warehouse.md)
