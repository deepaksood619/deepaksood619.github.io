---
slug: /ai/big-data/design-of-hbase
title: Design of HBase
description: Discover HBase, the scalable NoSQL database built on Hadoop, featuring
  a unique architecture, components, and advanced features like auto sharding and
