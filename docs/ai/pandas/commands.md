---
slug: /ai/pandas/commands
title: Commands
description: Explore the DataFrame.describe method to generate descriptive statistics
  for datasets, summarizing central tendency, dispersion, and shape, while handling
  mixed data types.
created: '2023-03-05'
