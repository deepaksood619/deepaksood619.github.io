...
description: Discover Masters' Union, a new-age business school in India offering experiential MBA alternatives with real-world projects.
created: 2026-05-04
updated: 2026-06-08
---
...
5. **Student Venture Funding Claims**
...
|--------|---------|---------------|
| **IIM Ahmedabad** | 2-year MBA | ₹33 lakhs |
| **ISB Hyderabad** | 1-year MBA | ₹36.3 lakhs |
| **Masters' Union** | 2-year PGP | **₹40-60 lakhs (est.)** |
...
| Metric | IIM Ahmedabad | ISB Hyderabad | Masters' Union (est.) |
|--------|---------------|---------------|------------------------|
| **Total Cost** | ₹33 lakhs | ₹36.3 lakhs | ₹40-60 lakhs |
| **Avg Salary** | ₹34.36 LPA | ₹34.07 LPA | ₹33.39 LPA |
| **Payback Period** | 1 year | 1.1 years | 1.2-1.8 years |
| **Brand Value** | Very High | Very High | Low (new) |
| **Accreditation** | AACSB, EQUIS | AACSB, EQUIS | EFMD member |
| **Alumni Network** | 50,000+ | 30,000+ | `<2000` |
