...
- [edX Analysis](education/competitors/moocs/edx-analysis.md) - MIT/Harvard platform, 86M learners, 2U acquisition, bankruptcy crisis
- [Khan Academy Analysis](education/competitors/moocs/khan-academy-analysis.md) - Free education pioneer, 150M learners, GPT-4 powered Khanmigo
...
- [ASI Analysis](education/competitors/adaptive-ai-platforms/asi-analysis.md) - Dubai AI-native startup, teenage founder, limited traction
...
- [Brilliant Analysis](education/competitors/adaptive-ai-platforms/brilliant-analysis.md) - Interactive STEM problem-solving, $299/year, 10M users, MIT/Harvard experts
...
- [Sana Labs Analysis](education/competitors/adaptive-ai-platforms/sana-labs-analysis.md) - Stockholm enterprise AI-LMS, Bayesian IRT + knowledge decay modeling, acquired by Workday for $1.1B (Nov 2025)
- [CENTURY Tech Analysis](education/competitors/adaptive-ai-platforms/century-tech-analysis.md) - UK school platform, "Anastasia" AI (cognitive neuroscience), EEF research validated, teacher-workload-reduction focus
- [Riiid Analysis](education/competitors/adaptive-ai-platforms/riiid-analysis.md) - Korea's Deep Knowledge Tracing pioneer, EdNet dataset (131M interactions), Santa TOEIC score prediction, SoftBank-backed

### China

- [Squirrel AI Analysis](education/competitors/adaptive-ai-platforms/squirrel-ai-analysis.md) - 30,000-point micro-granularity, DIKW + RL engine, 52M+ students, 3,000+ centers, Tom Mitchell (CMU) as Chief AI Officer; TIME100 Most Influential Companies 2026

### India — Adaptive Platforms

- [Embibe Analysis](education/competitors/adaptive-ai-platforms/embibe-analysis.md) - Reliance-backed, 93,659-node knowledge graph, DKT + ESQ score prediction, 40M students across 24 state governments; absorbed into Jio Platforms (April 2025)
- [Ei Mindspark Analysis](education/competitors/adaptive-ai-platforms/ei-mindspark-analysis.md) - Educational Initiatives, misconception-diagnosis AI, TARL methodology, J-PAL RCT evidence (0.37 SD gains in AER), 500K+ government school students
...
- [PhysicsWallah Analysis](education/competitors/india-edtech/physicswallah-analysis.md) - Only profitable edtech unicorn, ₹3K-10K/year (3-5x cheaper), bootstrap-to-IPO, $2.8B valuation; Aryabhata 1.0 SLM (90.2% JEE Math), Alakh AI suite, Project Bharat multilingual AI
- [Testbook Analysis](education/competitors/india-edtech/testbook-analysis.md) - Government exam test series specialist, 30M users, 4M paid, profitable since 2022, ~$42-48M revenue, 13-15% conversion, ₹500-2,999 pricing, 80+ languages, exam-realistic interface
...
- [Careers360 Analysis](education/competitors/india-edtech/careers360-analysis.md) - Career counseling & college information leader, 400M sessions/year, 18.3M monthly visits, 68.8% organic search, SEO-dominant, bootstrapped profitable, IIPM scam expose credibility, free predictor tools, multiple revenue streams
- [Shiksha Analysis](education/competitors/india-edtech/shiksha-analysis.md) - Info Edge owned career portal (Naukri.com sibling), 8-12M monthly visits, 2M+ users, 35K colleges, study abroad focus (₹50K-200K fees), ecosystem integration advantage, weaker SEO than Careers360, corporate-backed
...
- [Preplaced + Leeco Analysis](education/competitors/india-edtech/preplaced-leeco-analysis.md) - Two-product ecosystem: Preplaced (600+ MAANG mentors, 1:1 long-term mentorship, "30% cheaper, 4x better results") + Leeco.ai (AI job search autopilot, WhatsApp-based, referral automation claims 70% higher success), India-focused B2C, undisclosed funding/pricing, scalability challenges with 1:1 model

## New Age Schools & Alternative Education

- [Masters' Union Analysis](education/competitors/india-edtech/masters-union-analysis.md) - MBA alternative, ₹33.39L avg CTC, practical business education, ₹40-60L tuition
...
- [Consolidated EdTech Platforms](education/competitors/consolidated-edtech-platforms.md) - 20+ platforms: AI tutors (YouLearn, Tutor AI, Disha AI, Knowunity), edtech (Infinity Learn, Seekho, Unstop), bootcamps (Emeritus, Masai School, GrowthX), LMS (Frappe, Graphy, Edmingle)
	...
	- [GitHub - AntonioVFranco/openalgernon: A Claude Code-native study platform for AI engineers. Study playbooks, handbooks, and papers — entirely in your terminal. · GitHub](https://github.com/AntonioVFranco/openalgernon) ⭐ 1
