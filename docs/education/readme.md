...
- [Founder's Strategic Brief](education/strategy/founders-strategic-brief.md) - Market entry strategy, critical insights, business model
- [Pitch](education/strategy/pitch.md) - Vision, product strategy, non-profit model overview
- [Competitive Advantages](education/strategy/competitive-advantages.md) - Detailed competitive analysis and moats
- [Financial Sustainability](education/strategy/financial-sustainability.md) - Cost-recovery pricing, revenue projections
- [Funding Model](education/strategy/funding-model.md) - Grant sources, funding stages, donor stewardship

### Product Concepts (8 files)

Product ideas, features, and AI agent designs:

- [Personal Tutor](education/product-concepts/personal-tutor.md) - AI-powered adaptive learning system
- [AI as Mentor](education/product-concepts/ai-as-mentor.md) - AI mentorship framework
- [AI Assessment Platforms](education/product-concepts/ai-assessment-platforms.md) - Testing infrastructure
- [AI Mock Interview Platform](education/product-concepts/ai-mock-interview-platform.md) - Interview prep
- [AI Coding Test Platform](education/product-concepts/ai-coding-test-platform.md) - Technical assessment
- [Life Recorder](education/product-concepts/life-recorder.md) - Learning journal system
...
- [Chunking the Essentials](education/pedagogy/chunking-the-essentials.md)
- [Exams](education/pedagogy/exams.md)
- [Tips](education/pedagogy/tips.md)
...
- [Khan Academy Analysis](education/competitors/moocs/khan-academy-analysis.md) - Free education pioneer, 150M learners, GPT-4 powered Khanmigo (see Khanmigo failure analysis below)
- [Brilliant Analysis](education/competitors/adaptive-ai-platforms/brilliant-analysis.md) - Interactive STEM learning, 10M users, $299.88/year, "learning by doing" (no videos), Koji AI tutor, K-12 + lifelong learners, $50M valuation (2019)
...
- [PhysicsWallah Analysis](education/competitors/india-edtech/physicswallah-analysis.md) - Only profitable edtech unicorn, ₹3K-10K/year (3-5x cheaper), bootstrap-to-IPO, $2.8B valuation, 10:1 to 80:1 LTV/CAC ratio
...
- [Technical Hiring Assessment Market](education/competitors/technical-hiring-assessment-market.md) - $8-10B TAM analysis (competitors folder)
...
- [Schooling vs Homeschooling](education/pedagogy/schooling-vs-homeschooling.md) - Comparison framework
