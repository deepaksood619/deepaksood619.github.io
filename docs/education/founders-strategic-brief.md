...
- **Coursera:** 168M learners, $695M revenue, **never profitable** in 13 years. Stock down 50-70% from IPO. Eliminated free auditing (Dec 2024) → mass user exodus to YouTube/ChatGPT.
...
- **Unacademy (India):** Valuation crashed **85%** ($3.4B → `<$500M`). Acquired by upGrad in distressed sale (March 2026). Teacher marketplace model failed, completion rates `<10%`.
...
2. [Adaptive Learning Platform Concept](education/adaptive-learning-platform.md) - $2-3B market, 300M+ working professionals
